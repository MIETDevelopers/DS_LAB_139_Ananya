...
// Purpose ---   
         //  Write a C program  compare the running times (in milliseconds) of following
		 //1st. Bubble Sort 
		 //2nd. Merge Sort 
...
printf("\n   \t\t     AG         ---->>>>>		Tiem Calculator		<<<<<------    AG \n\n\n");
	...
	printf("\n  2.)Merge sort will divide in two the data-set until all the elements are separate ");
	...
	printf(" \n 6.)It is a bit more complex than Selection and Bubble Sort but its more efficient.");
